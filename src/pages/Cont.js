...
function Cont() {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            ...
            const message = `Hola, me gustaría recibir información sobre la carrera de Contabilidad y Finanzas.
...
- Teléfono: ${formData.telefono}`;
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-6">
                <img
                    src='../assets/images/contabilidad_portada.jpg'
                    alt="Portada de Contabilidad y Finanzas"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white shadow-lg p-6 rounded-lg">
                            ...
                            <p class="mt-2 text-gray-600">
                                ...
                                <li>Plan Contable General Empresarial.</li>
                                <li>Operaciones Contables Auxiliares.</li>
                        ...
                        <div class="bg-white shadow-lg p-6 rounded-lg">
                            ...
                            <p class="mt-2 text-gray-600">
                                ...
                                <li>Administración Financiera y Procesos NIC - NIF.</li>
                                <li>Taller de Finanzas Empresariales.</li>
                        ...
                        <div class="bg-white shadow-lg p-6 rounded-lg">
                            ...
                            <p class="mt-2 text-gray-600">
                                ...
                                <li>Formulación de Estados Financieros.</li>
                                <li>Finanzas de Corto Plazo.</li>
                        ...
                        <div class="bg-white shadow-lg p-6 rounded-lg">
                            ...
                            <p class="mt-2 text-gray-600">
                                ...
                                <li>Finanzas de Largo Plazo.</li>
                                <li>Contabilidad de Sociedades Financieras.</li>
                        ...
                        <div class="bg-white shadow-lg p-6 rounded-lg">
                            ...
                            <p class="mt-2 text-gray-600">
                                ...
                                <li>Tópicos de E-Comerce, BI y BSC.</li>
                                <li>Administración Financiera.</li>
                                <li>Plan de Marketing y Comercio Internacional.</li>
                                <li>Sistema de Empresas Emergentes.</li>
                                <li>Diseño y Gestión de Nuevos Negocios.</li>
            ...
            <section id="que-obtienes" className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                    Al culminar esta carrera, obtendrás el Título Profesional a Nombre de la Nación del Ministerio de Educación: Profesional Técnico en Contabilidad y Finanzas.
                </p>
            </section>
